  ...
  List<TranslationJob> _seedJobs() {
    ...
    return <TranslationJob>[
      TranslationJob(
        ...
        lineCount: duneLines.length,
        durationMs: duneLines.isEmpty ? 0 : duneLines.last.endMs,
        lines: duneLines,
        progress: 1,
      ),
      TranslationJob(
        ...
        lineCount: bearLines.length,
        durationMs: bearLines.isEmpty ? 0 : bearLines.last.endMs,
        lines: bearLines,
        progress: 1,
      ),
    ];
